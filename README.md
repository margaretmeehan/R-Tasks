...
- [Install R Packages Extension](https://marketplace.visualstudio.com/items?itemName=cse-nyc.install-r-packages)
- [Run R Script Extension](https://marketplace.visualstudio.com/items?itemName=cse-nyc.run-r-script)
